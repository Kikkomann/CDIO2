...
public class Game {
	...
	public Game() {
		...
		field[1] = new Field("Crater",
				"As you walk in the forest you are not paying attention to the path and fall into a crater. You can't get up yourself and after two hours of crying for help, someone finds you and helps you up. He charge you 100 for the help",
				-100, false);
		...
		field[6] = new Field("Black Cave",
				"You come to the end of the forest path and find a black cave. You are getting hungry and buy a sandwich at the Sandwich Man before you explore the cave. It is a delicious sandwich and it only costed you 70.",
				-70, false);
		field[7] = new Field("Huts in the Mountains",
				"You decided to go to the mountains and discover some huts. People like you so much that they want to give you a present. It is an ugly statue that you sell for 60.",
				60, false);
		field[8] = new Field("The Werewall",
				"You don't realize that you have come to the dangerous area in the kingdom - the Werewall. The werewolfes spot you and tries to catch you. You try to pay you out of the situation, but apparently 80 is not enough to help you. You run as fast as you can, and moves on quickly. You better roll again.",
				-80, true);
		field[9] = new Field("The Pit",
				"It is getting late and the only place that is open now is The Pit. Tonights theme adventure-party. Entrance is 50 and you go in and party all night.",
				-50, false);
	...
	public boolean checkWinner() {
		...
		if (player[0].getBalance() >= 3000 && player[1].getBalance() >= 3000) {
			...
			GUI.showMessage(player[0] + " has won. Congratulations!");
			return true;
		} else if (player[1].getBalance() >= 3000) {
			GUI.showMessage(player[1] + " has won. Congratulations!");
			return true;
		} else
			return false;
	}
